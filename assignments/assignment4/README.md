...
The output file is located [on S3](https://w205-rcordell-assignment4.s3.amazonaws/WC2015.csv). The CSV uses a delimiter of '|' so as to preserve some of the punctuation in the tweet text which may be commas. The file contains 128,948 entries.
